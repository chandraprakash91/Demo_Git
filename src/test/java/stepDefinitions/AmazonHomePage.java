...
public class AmazonHomePage {
	...
	public void user_gets_amazon_search_field() {
	...
	@Then("user gets product and price details")
	public void user_gets_product_and_price_details() {
	...
	@Given("user is on Amazon home page")
	public void user_is_on_amazon_home_page1() {
	...
	@Then("user gets all Amazon services link")
	public void user_gets_all_amazon_services_link(DataTable dataTable) {
